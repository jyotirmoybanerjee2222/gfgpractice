<h2><a href="https://www.geeksforgeeks.org/problems/nth-fibonacci-number1335/1?page=1&category=Mathematical&difficulty=Easy&sortBy=submissions">Nth Fibonacci Number</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a non-negative integer n, your task is to find the nth Fibonacci number.</span></p>
<blockquote>
